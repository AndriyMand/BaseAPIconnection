...
class CategoriesController extends AbstractController
{
    ...
    {
        $categoriesTree = $categories->buildTree();
        $categories->getCategoryList($categoriesTree);
        $categories->getCategoryOptionList($categoriesTree);
        ...
        {
            $in_invalid = ' is-invalid';
        }
        
        return $this->render('admin/categories.html.twig',[
            'categories'         => $categories->categorylist,
            'categories_options' => $categories->categorylistOptions,
     ...
     */
    public function editCategory(Category $category, CategoryTreeAdminList $categories, Request $request)
    {
    ...
    public function getAllCategories(CategoryTreeAdminList $categories, $editedCategory = null)
    {
